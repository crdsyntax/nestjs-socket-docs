...
export class StandaloneServer {
  ...
  private readonly uiDistPath: string;
  private readonly discoveryEnabled: boolean;
  private readonly discoveryPorts: number[];
   ...
   */
  private sanitizePath(urlPath: string, baseDir: string): string | null {
   ...
   */
  private probePort(port: number): Promise<DiscoveredServer | null> {
   ...
   */
  async discoverLocalServers(ports?: number[]): Promise<DiscoveredServer[]> {
